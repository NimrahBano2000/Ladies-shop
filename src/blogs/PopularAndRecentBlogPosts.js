...
const Title = tw.h5`mt-6 text-xl font-bold transition duration-300 group-hover:text-gray-500`;
const Description = tw.p`mt-2 font-medium text-gray-100 leading-loose text-sm`;
...
const RecentPostsContainer = styled.div`
  ...
  ${AuthorName} {
    ${tw`mt-3 text-sm text-gray-100 font-normal leading-none`}
  }
  ${Image} {
