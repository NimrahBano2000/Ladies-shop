...
export default () => {
  ...
  const cards = [
    {
      imageSrc: "https://cdn.shopify.com/s/files/1/0566/0177/2222/products/IMG_0990-scaled_360x.jpg?v=1621181112",
      title: "Long Frock",
    ...
    {
      imageSrc: "https://cdn.shopify.com/s/files/1/0566/0177/2222/products/IMG_0310_360x.jpg?v=1621181093",
      title: "Maxi",
      description: "Available in Small, Medium and large sizes.",
      locationText: "F5671",
      pricingText: "6000PKR",
    ...
    {
      imageSrc: "https://cdn.shopify.com/s/files/1/0566/0177/2222/products/IMG_4947_360x.jpg?v=1621181191",
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          {cards.map((card, index) => (
            <Card key={index}>
             ...
             <PrimaryButton>
              <PrimaryLink href="/cart">Book Now</PrimaryLink>
              </PrimaryButton>
            </Card>
          ))}
        </CardSlider>
