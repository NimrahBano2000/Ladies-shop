...
import Header, { NavLink } from "headers/light.js";
            ...
            <FormContainer>
              <SocialButtonsContainer>
                {/* {socialButtons.map((socialButton, index) => ( */}
                  <SocialButton className="mb-3"  href="">
              ...
              <SocialButtonsContainer className="mb-3">
                {/* {socialButtons.map((socialButton, index) => ( */}
                  <SocialButton className="mb-3" href="">
                    {/* <span className="iconContainer"> */}
                      {/* <img src={socialButton.iconImageSrc} className="icon" alt=""/> */}
                    {/* </span> */}
                    <span className="text">Login as Vendor</span>
                  </SocialButton>
                {/* // ))} */}
              </SocialButtonsContainer>
              <DividerTextContainer>
                <DividerText>Or Sign in as a User</DividerText>
              </DividerTextContainer>
              <Form>
